...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      {/* cambiar a between si se le agrega search */}
      <div className="flex flex-grow items-center justify-end sm:justify-between   px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <span className='text-black dark:text-white uppercase font-extrabold text-xs md:text-xl'>
          Valplas Gestión
        </span>
        ...
        <div className="flex items-center gap-3 2xsm:gap-7 ">
          <ul className="flex items-center gap-2 2xsm:gap-4">
            ...
            {isAuthenticated && <DropdownNotification />}
            {/* <!-- Notification Menu Area --> */}

            {/* <!-- Chat Notification Area --> */}
            {isAuthenticated && <DropdownMessage />}
            {/* <!-- Chat Notification Area --> */}
          </ul>
          {/* <!-- User Area --> */}
